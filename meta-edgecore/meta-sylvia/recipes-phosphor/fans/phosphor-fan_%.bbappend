...
PACKAGECONFIG_append_sylvia = " cooling-type"
...
SYSTEMD_ENVIRONMENT_FILE_phosphor-cooling-type_append_sylvia = " ${@compose_list(d, 'COOLING_ENV_FMT', 'OBMC_CHASSIS_INSTANCES')}"
